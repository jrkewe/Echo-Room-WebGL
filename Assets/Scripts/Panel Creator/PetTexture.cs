...
public class PetTexture : MonoBehaviour
{
    //Buttons
    ...
    private void ApplyTexture()
    {
        if (mousePositionScript.selectedObject != null)
        {
            ...
            {
                case 0:
                    mousePositionScript.selectedObject.transform.GetChild(1).gameObject.transform.GetChild(1).gameObject.GetComponent<Renderer>().material = material;
                    break;
                case 1:
                    mousePositionScript.selectedObject.transform.GetChild(1).gameObject.transform.GetChild(1).gameObject.GetComponent<Renderer>().material = material;
                    break;
