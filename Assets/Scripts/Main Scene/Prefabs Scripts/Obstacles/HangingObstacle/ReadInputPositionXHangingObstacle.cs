...
public class ReadInputPositionXHangingObstacle : MonoBehaviour
{
    //Debuger
    public static ILogger debugReadInputPositionXHangingObstacle = new Logger(Debug.unityLogger.logHandler);
    ...
    {
        //Debugger
        debugReadInputPositionXHangingObstacle.logEnabled = false;
